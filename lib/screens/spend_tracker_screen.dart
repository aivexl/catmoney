...
class _SpendTrackerScreenState extends State<SpendTrackerScreen> {
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text(
                    AppLocalizations.of(context).spendTracker,
          ...
          Padding(
            ...
            child: Text(
              AppLocalizations.of(context).manageBudget,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(AppLocalizations.of(context).noBudgets,
  ...
  Widget _buildBudgetCard(Budget budget, BudgetProvider provider) {
    return Card(
      ...
      color: budget.color ?? Theme.of(context).cardColor,
      child: InkWell(
